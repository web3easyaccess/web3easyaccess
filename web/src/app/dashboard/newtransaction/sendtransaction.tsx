        ...
        <>
            ...
            >
                <Tab key="sendETH" title="Send ETH">
                    <SendTabShow
                        myKey="sendETH"
                        updateInputFillInChange={updateInputFillInChange}
                    />
                </Tab>
...
function TokenList() {
    const aa = [
        { addr: "0x1234", name: "usdt" },
        { addr: "0xabcd", name: "w3eap" },
    ];
    return (
        <Select
            items={aa}
            label="select or input Token address"
            className="max-w-xs"
            variant="bordered"
            classNames={{
        ...
        >
            {(aa) => (
                <SelectItem key={aa.addr} textValue={aa.addr}>
                    <div className="flex gap-2 items-center">
                        ...
                        />
                        <div className="flex flex-col">
                            <span className="text-small">{aa.name}</span>
...
function SendTabShow({
    myKey,
    updateInputFillInChange,
}: {
    myKey: string;
    updateInputFillInChange: any;
}) {
    console.log("send ssss myKey:", myKey);
    const showTokenInfo = () => {};
    return (
                        ...
                        <div>
                            ...
                            >
                                <Input
                                    ...
                                    type="text"
                                    variant={"bordered"}
                                    label="please input Token Address"
                                    placeholder="please input Token Address"
                                    onBlur={showTokenInfo}
                                />
                            </div>
                        </div>
                    ) : null}
...
>>>>>>> 106e830548a1c9cc5ee572a87b4b18c3ed84ec07
