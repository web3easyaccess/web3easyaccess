...
function checkInfo(
    ...
    if (!pwdRegex.test(pin1)) {
        alert("PIN rule error!");
        throw new Error("PIN rule error!");
    }
    if (
        question1_answer_1 == "" ||
        question1_answer_1 == undefined ||
        question1_answer_1.length < 2
    ) {
        alert("first question's answer too short!");
        throw new Error("question1_answer_1 too short!");
    }
    if (
        question2_answer_1 == "" ||
        question2_answer_1 == undefined ||
        question2_answer_1.length < 2
    ) {
        alert("second question's answer too short!");
        throw new Error("question2_answer_1 too short!");
    }
}
