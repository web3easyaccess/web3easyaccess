...
contract AccountLogicImplV1Script is Script {
    ...
    function run() public {
        ...
        // anvil: 0xc5a5C42992dECbae36851359345FE25997F5C42d
    }
}
/*

forge script script/02DeployAccountLogicImplV1.s.sol:AccountLogicImplV1Script --private-key 0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80 --broadcast --rpc-url http://127.0.0.1:8545 --slow --via-ir --legacy
