...
contract W3EAPointScript is Script {
    function setUp() public {}

    function run() public {
        vm.broadcast();
        W3EAPoint m = new W3EAPoint(0x5FbDB2315678afecb367f032d93F642f64180aa3);
    }
}
...
/*
forge script script/02DeployW3EAPoint.s.sol:W3EAPointScript --private-key 0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80 --broadcast --rpc-url http://127.0.0.1:8545 --slow --via-ir --legacy
