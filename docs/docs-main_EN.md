...
1. Add new features to the transaction initiation page: token transfer, NFT transfer, custom transaction parameters, swap integration, and built-in L2 to L1 bridge.
2. Add account guardianship feature
3. Integrate more chains (EMV and others)
4. Assets are denominated in U
5. Gas fees can be paid with other assets
6. Account contract upgrade.
7.
