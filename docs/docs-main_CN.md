...
3. 新增功能: L2(Linea or Scroll) 和以太坊主网的资产桥接;
4. 压力测试与优化,并升级硬件资源;
5. 调整交互奖励模型;
6. 一个 测试网用户测试;
7. 上线 L2(Linea or Scroll) 正式网;
8. 小范围推广，目标是链上交易地址数不低于 100.

-   2024Q4:

9. 新增功能: L2(Linea or Scroll) 上密码修改与以太坊主网之间的同步;
10. 新增功能: 自定义交易参数;
11. 新增功能: 对接封装 L2(Linea or Scroll) 上 tvl 第一的 dex swap;
